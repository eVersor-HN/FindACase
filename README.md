...
**FindACase** is a single-file encryption app that locks your files into **one standard
...
> **FindACase is free.** If it keeps your files safe, you can support development with a
